  ...
  methods:{
    ...
    goRisk() {
      ...
      apis.userBaseData(userId,'1').then( (data) => {
        ...
        if (investscore == "0") {
          let url = 'https://www.phtfdata.com/web6/hander/investor.do?CUST_ID=' + userId;
          window.location.href = url;
        } else{
          let url = 'https://www.phtfdata.com/web6/hander/investorResult.do?CUST_ID=' + userId + '&INVEST_SCORE=' + invest_score;
          window.location.href = url;
        }
      })
    },
