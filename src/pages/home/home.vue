<template>
  <keep-alive include="home">
    <div class="home" v-title="'融资'">
      ...
      <div class="news">
        <div class="news_img">
          <router-link to="/announcementList"><img src="../../../static/images/home_announcement.png"></router-link>
        </div>
        <b class="shuxian"></b>
      ...
      <div class="yyy_area">
        ...
        <router-link :to="{path: 'yyyParticulars', query: {  name: 'home',id: item.PROJ_CODE}}"
                     v-for="(item , index) in recommendedProject_yyy">
          <ul>
      ...
      <div class="yyy_area">
        ...
        <router-link :to="{path: 'dcyParticulars', query: {  name: '123',url: 'home'}}"
                     v-for="(item ,index) in recommendedProject_dcy" :key="index">
          <ul>
            <li>{{item.PROJ_NAME}}</li>
            <li>
            <span>
...
//      getUserInfo.getCode()
      ...
      //检验SDK
      inspectSdk (){
//        alert(phtServer.getNetworkType())
      }
