    ...
    <div class="announcement">
        ...
        <div class="announcement_nav">
            <router-link to="/announcementList">
                <li>
                    <span>公告<img src="../../../static/images/announcement/announcement_news_sign.png"></span>
                </li>
            </router-link>
            <router-link to="/newsList">
                <li>
                    <span class="on">新闻<img src="../../../static/images/announcement/announcement_news_sign.png"></span>
                </li>
            </router-link>
        </div>
        <!-- 新闻列表 -->
        <scroller class="news_list" :on-refresh="refresh" :on-infinite="infinite">
            <ul>
                <router-link :to="{path: 'news', query: {  name:'123',url: 'newsList'}}" v-for="item in items" :key="index">
                    <li>
                        <h1>关于招商银行恢复使用公告</h1>
                        <h2>{{item}}</h2>
